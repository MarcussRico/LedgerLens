...
export const pillars: PillarSpec[] = [
  {
    n: 1, key: 'dup', pillar: 'Duplicates & Overpayment', accent: 'gold', precision: 0.935, findings: 41,
  ...
  {
    n: 3, key: 'behav', pillar: 'Behavioural Anomalies', accent: 'signal', precision: 0.870, findings: 47,
